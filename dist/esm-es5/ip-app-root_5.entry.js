...
import { r as registerInstance, h, c as createEvent, g as getElement, d as getContext } from './index-92c20e76.js';
...
var IpAppRoot = /** @class */ (function () {
    function IpAppRoot(hostRef) {
        registerInstance(this, hostRef);
        this.pageState = [];
    }
    IpAppRoot.prototype.onPageEnter = function (e) {
        this.pageState = __spreadArrays(this.pageState, ["Page enter " + e.detail.pathname]);
    };
    IpAppRoot.prototype.onPageLeave = function (e) {
        this.pageState = __spreadArrays(this.pageState, ["Page leave " + e.detail.pathname]);
    };
    IpAppRoot.prototype.render = function () {
        return (h("main", null, h("stencil-router", null, h("stencil-route-switch", { scrollTopOffset: 0 }, h("stencil-route", { url: "/", component: "ip-app-home", exact: true, routeRender: function (props) { return h("ip-stencil-route-listener", { props: props }); } }), h("stencil-route", { url: "/about", exact: true, component: "ip-app-about", routeRender: function (props) { return h("ip-stencil-route-listener", { props: props }); } }))), h("ul", null, this.pageState.map(function (page) { return (h("li", null, page)); }))));
    };
    return IpAppRoot;
}());
var lastKey = '';
var lastEvent = '';
var props;
var IpStencilRouteListener = /** @class */ (function () {
    function IpStencilRouteListener(hostRef) {
        registerInstance(this, hostRef);
        this.localPageSegments = null;
        this.pageEnter = createEvent(this, "pageEnter", 7);
        this.pageLeave = createEvent(this, "pageLeave", 7);
    }
    Object.defineProperty(IpStencilRouteListener.prototype, "currentPageLocation", {
        get: function () {
    ...
    IpStencilRouteListener.prototype._callEvent = function (event, location) {
    ...
    IpStencilRouteListener.prototype.componentWillLoad = function () {
        if (!this.props) {
    ...
    IpStencilRouteListener.prototype.componentDidLoad = function () {
        if (lastKey === this.currentPageLocation.key) {
            this._callEvent('pageEnter', this.currentPageLocation);
        }
    };
    IpStencilRouteListener.prototype.componentDidUnload = function () {
        if (lastKey !== this.currentPageLocation.key) {
            this._callEvent('pageLeave', this.localPageSegments);
        }
    };
    IpStencilRouteListener.prototype.componentWillUpdate = function () {
        if (lastKey !== this.currentPageLocation.key) {
            this._callEvent('pageLeave', this.localPageSegments);
        }
    };
    IpStencilRouteListener.prototype.componentDidUpdate = function () {
        if (lastKey !== this.currentPageLocation.key) {
            this._callEvent('pageEnter', this.currentPageLocation);
            this.localPageSegments = this.currentPageLocation;
            lastKey = this.currentPageLocation.key;
    ...
    IpStencilRouteListener.prototype.render = function () {
        return h(this.props.component, Object.assign({}, this.props));
    };
    return IpStencilRouteListener;
}());
...
export { IpAppRoot as ip_app_root, IpStencilRouteListener as ip_stencil_route_listener, Route as stencil_route, RouteSwitch as stencil_route_switch, Router as stencil_router };
