...
const IpAppRoot = class {
    ...
    render() {
        return (index.h("main", null, index.h("stencil-router", null, index.h("stencil-route-switch", { scrollTopOffset: 0 }, index.h("stencil-route", { url: "/", component: "ip-app-home", exact: true, routeRender: props => index.h("ip-stencil-route-listener", { props: props }) }), index.h("stencil-route", { url: "/about", exact: true, component: "ip-app-about", routeRender: props => index.h("ip-stencil-route-listener", { props: props }) }))), index.h("ul", null, this.pageState.map(page => (index.h("li", null, page))))));
    }
};
...
const IpStencilRouteListener = class {
    constructor(hostRef) {
        ...
        this.pageEnter = index.createEvent(this, "pageEnter", 7);
        this.pageLeave = index.createEvent(this, "pageLeave", 7);
    }
    ...
    render() {
        return index.h(this.props.component, Object.assign({}, this.props));
    }
};
...
exports.ip_app_root = IpAppRoot;
exports.ip_stencil_route_listener = IpStencilRouteListener;
